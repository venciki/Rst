<template>
  <div id="app">
     <div class="content2" v-show="isshow">
          <div id="section_addElement_box">
            <div id="section_addElement_box_title">
              <span>新增人员</span>
              <div id="section_addElement_box_title_close" @click="show">X</div>
            </div>
            <div id="section_addElement_box_name">
              <span>资料名称：</span>
...
export default {
  ...
  methods: {
    update() {
      ...
      formData.append("materialName", document.getElementById("btn1").value);
      var options = {
        // 设置axios的参数
        url: "http://localhost:8084/material/fileUpload",
        data: formData,
        method: "post",
        headers: {
